...
lang_alternate: /en/cooperative/valeurs/
hero_h1_pre: Nos
hero_h1_em: valeurs
hero_subtitle: "Ces valeurs sont nos pilliers et notre direction"
section_nav:
  - { id: respect,      label: Respect }
  - { id: inclusivite,  label: Inclusivité }
  - { id: transparence, label: Transparence }
  - { id: no-ia,        label: "No IA gen" }
values:
  - id: respect
    number: "01"
    heading: "Respect des créations"
    intro: "Chaque jeu signé est traité avec la même considération, indépendamment de son statut ou de sa réussite financière."
    bullets:
      - title: "Égalité de traitement"
        body: "Tous les jeux signés sont accompagnés avec la même attention, peu importe leur visibilité ou leurs ventes."
  ...
  - id: transparence
    ...
    bullets:
      ...
      - title: "Sociétaires consultés"
        body: "Les sociétaires motivés sont sollicités sur les décisions et les stratégies."
  - id: inclusivite
    number: "03"
  ...
  - id: no-ia
    number: "04"
    heading: "Non à l'IA générative"
    intro: "Notre position sur l'IA générative est simple et ferme. Nous considérons qu'elle précarise les artistes, aseptise la créativité et consomme des ressources déraisonnables."
    bullets:
